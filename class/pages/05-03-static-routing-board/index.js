...
export default function StaticRoutingPage() {
  ...
  const onClickMove1 = () => {
    router.push("/05-04-static-routed/4")
  }
  const onClickMove2 = () => {
  ...
  return (
    <div>
      <button onClick={onClickMove1}>4번 게시글 이동</button>
      <button onClick={onClickMove2}>5번 게시글 이동</button>
      <button onClick={onClickMove3}>7번 게시글 이동</button>
    </div>
  )
